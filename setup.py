...
setup(
    name="ntv_numpy",
    version="0.1.0",
    description="NTV-NumPy : A multidimensional semantic, compact and reversible JSON-NumPy converter",
    ...
    keywords="numpy, JSON-NTV, semantic JSON, development, environmental data",
